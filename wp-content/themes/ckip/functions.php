...
function _tk_scripts() {
    ...
    wp_enqueue_script( '_tk-modernizer', get_template_directory_uri() . '/includes/js/modernizr.custom.js', array() );

    wp_enqueue_script( '_tk-classie', get_template_directory_uri() . '/includes/js/classie.js', array() );
