...
<div class="overlay overlay-hugeinc">
    ...
    <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
        <p><?php _e( 'Search on page', 'nps' ); ?></p>
        <input type="search" class="search-field" placeholder="<?php _e( 'Search...', 'nps' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" title="<?php _ex( 'Search for:', 'label', 'nps' ); ?>">
